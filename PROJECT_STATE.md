...
- Authorized unified-input implementation: `benchmarks/industry_input_v2/integration_plan.md`. Production defaults/frozen loaders unchanged; explicit dated research input now drives scores, risk, qualification and attribution, with isolated cache/account identities. 70 affected tests passed; added cache isolation test and existing config-cache test passed; Ruff and mypy (9 affected modules) pass. Main-control source `3ad3f4b7e63215484c118d05a864a5c17390ddf5ca5442d624ab92f044fa04bc`, remote control `bcda577e772b42412bf2b8eb0a034e2f3b55acb1`. Final 6-day old/revised readbacks pass; default metrics/attribution equal unmodified main. Three registered full-window old/new pairs running under `/dev/shm/uquant-taxonomy-evidence-20260909`; inspect existing outputs/processes before any restart. `opportunity_coverage_gaps.json` and `h1_role_diagnosis.json` retain follow-up gaps and first pending-order qualification divergence. No economic result or promotion yet.
