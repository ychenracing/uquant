"""Read back the deployment-only diagnostic against preserved canonical controls."""
import gzip
import hashlib
import json
...
for pool in ("a", "e", "remove308-prefix"):
    ...
    assert candidate["commit"] == "7b000bc9170e6c9233dd82fd38bc34613be0fafd"
    ...
    assert changed == {"uquant/portfolio/pipeline.py"}, changed
