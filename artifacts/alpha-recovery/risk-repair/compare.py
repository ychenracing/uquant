"""Read preserved sector-repair diagnostics against matching canonical controls."""
...
repo = root.parents[2]
candidate_commit = "0080f419a35b7c8067a5d4c337fe86ff11533ddf"
baseline_commit = "6f8de5c02ff1161b78ef42e63e91f36d35c6bfc0"
expected_changes = {
    "uquant/risk_sector.py",
...
for pool in ("a", "e", "remove308-prefix", "e-h2"):
    ...
    candidate_path = root / ("candidate-e-h2.json.gz" if pool == "e-h2" else pool + ".json.gz")
    baseline_path = (root / "current-e-h2.json.gz" if pool == "e-h2" else
    ...
    result = {
        ...
        "baseline_path": str(baseline_path.relative_to(root.parent)),
