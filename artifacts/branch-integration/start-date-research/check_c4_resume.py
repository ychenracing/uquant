...
with gzip.open("../diagnostic-c4c/2023-01-10.json.gz") as stream:
    rows = json.load(stream)
results = []
for checkpoint in ["2023-01-18", "2023-01-20"]:
    ...
    for date in calendar[(calendar > checkpoint) & (calendar <= "2023-01-31")]:
    ...
    results.append({"checkpoint": checkpoint, "end": "2023-01-31", "account_and_decision_identical": True})
Path("../c4-resume-result.json").write_text(json.dumps(results, indent=2) + "\n")
