...
rows = [
    (label, root.parent / folder, ("recovery-2025", p["symbols"], p["start"], 1))
    for label, folder in [
        ("c1", "uquant-c1"),
        ("proportional", "uquant-proportional"),
        ("entry-unweighted", "uquant-entry-unweighted"),
        ("tactical-original", "uquant-tactical-original"),
    ]
]
