...
for key, name, disabled, folder in [
    ("mechanism_window", "recovery-2025", "c7-entry-off", "uquant-c7-entry-off"),
    ("additional_mechanism_window", "normal-tactical-2023", "c7-tactical-off", "uquant-c7-tactical-off"),
]:
    window = contract[key]
    for label, checkout in [("c7", "uquant-c7"), (disabled, folder)]:
        rows.append(
