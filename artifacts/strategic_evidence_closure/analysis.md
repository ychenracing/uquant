...
**NOT_ESTABLISHED**. Common-date controls completed, but native-date
...
**SENSITIVE**. The result contains
29 singleton minimal witnesses
and the ghost-witness list is retained in the compact summary.

## State reachability

**PARTIAL_DIAGNOSTIC_ONLY**. The validated bundle contains
84 synthetic `DIAGNOSTIC_ONLY` cells. R7 was observed in
0 cells and repeated crowning satisfied
13 of
84 cells. Synthetic
...
**NOT_CLOSED**. The frozen S09/P05 witness-missing recovery fraction
is `0.0` versus the literal
