...
战略软 ATR 退出在同一次连续破位中不逐日重复推进。当前目标实际完整成交后，保留剩余
股份及价格漂移；只有有效行情确认原信号解除、之后再次触发，才按原有分段幅度降低新的
计划目标。缺失或非有限行情不能重置触发状态，最小成交金额与股数要求仍然适用。
冲量全档退出、损伤修复后的升级退出、灾难止损、利润保护和独立风险上限仍有效。
新的软退出可能释放真实接棒所需的资金，也可能放弃旧持仓后续上涨，不能视为收益保证。
