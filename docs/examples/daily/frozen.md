...
- 当前持有 0 只；目标持有 1 只；买入意图 0 项；卖出意图 0 项
- 现金余额：100,000.00 元；不等于可用买入资金，未成交卖单不释放现金或名额

## 下一可交易日需要核对的事项

- 没有记录买卖意图；不把目标仓位当作订单，具体受阻或未评估原因见逐票说明
- 逐单核对券商回报、可用资金、可卖股份、停牌／涨跌停、成交量和价格；意图不是券商已接受、可立即成交或已经成交

## 逐只股票：sz300308

- 当前情况：未持有
- 最终处理：保留目标／观察，未生成买入意图；也未生成卖出意图
- 目标仓位：20.00%
...
原始原因、原因码、订单身份、配置指纹和账户事实如下。

    {
      ...
      "decision": {
        "date": "2025-01-06",
        "decision_digest": "TEST_FIXTURE_frozen",
        "opportunity": "TREND",
        "pending_orders": [],
        "risk": "NORMAL",
        "risk_summary": {
          ...
          "core_allocation": {
            "final_freeze_new_risk": true,
            "scope": "FINAL_DECISION",
            "symbols": {
              "sz300308": {
                "allocation_reason": "FROZEN",
                "entry": {
                  "block": "READY",
                  "checks": {
                    "confidence": {
