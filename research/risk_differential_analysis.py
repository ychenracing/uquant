...
closure_outcome = _closure_outcome
counterfactual_summary = _counterfactual_summary
detection_gate_details = _detection_gate_details
economic_gate = _economic_gate
generalization_gate = _generalization_gate
validate_analysis_inputs = _validate_analysis_inputs
