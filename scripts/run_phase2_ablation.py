...
from research.phase2_ablation_cli import (
    BASELINE_CARRIER_SHA256 as _BASELINE_CARRIER_SHA256,
)
from research.phase2_ablation_cli import CAUSAL_STAGES as _CAUSAL_STAGES
from research.phase2_ablation_cli import (
...
from research.phase2_ablation_cli import canonical_bytes as _canonical_bytes
from research.phase2_ablation_cli import (
...
from research.phase2_ablation_cli import evidence_coverage as _evidence_coverage
from research.phase2_ablation_cli import (
...
from research.phase2_ablation_cli import git_output as _git_output
from research.phase2_ablation_cli import (
    isolated_evidence_checkout as _isolated_evidence_checkout,
)
from research.phase2_ablation_cli import load_json_mapping as _load_json_mapping
from research.phase2_ablation_cli import (
    load_trusted_evidence_manifest as _load_trusted_evidence_manifest,
)
from research.phase2_ablation_cli import main, phase2_cli_seams
from research.phase2_ablation_cli import probe_checkout as _probe_checkout
from research.phase2_ablation_cli import read_baseline_result as _read_baseline_result
from research.phase2_ablation_cli import read_checkpoint as _read_checkpoint
from research.phase2_ablation_cli import (
    read_experiment_result as _read_experiment_result,
)
from research.phase2_ablation_cli import read_worker_artifact as _read_worker_artifact
from research.phase2_ablation_cli import replay_cell as _replay_cell
from research.phase2_ablation_cli import replay_command as _replay_command
from research.phase2_ablation_cli import (
    select_experiment_result_path as _select_experiment_result_path,
)
from research.phase2_ablation_cli import sha256_mapping as _sha256_mapping
from research.phase2_ablation_cli import (
...
from research.phase2_ablation_cli import validate_replay_command as _validate_replay_command
from research.phase2_ablation_cli import validate_worker_payload as _validate_worker_payload
from research.phase2_ablation_cli import write_baseline_result as _write_baseline_result
from research.phase2_ablation_cli import write_checkpoint as _write_checkpoint
from research.phase2_ablation_cli import (
    write_experiment_result as _write_experiment_result,
)
from research.phase2_ablation_cli import write_worker_artifact as _write_worker_artifact
...
def _baseline_config_sha256(source_root: Path) -> str:
    with phase2_cli_seams(probe_checkout_seam=_probe_checkout):
