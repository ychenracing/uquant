...
MODULE_AUTHORITIES = {
    ...
    "uquant.account.schema_migration": "production_safe",
    "uquant.account.store": "production_safe",
    "uquant.account.transaction": "production_safe",
    ...
    "uquant.broker_facts": "production_safe",
    ...
    "uquant.data_check": "production_safe",
    "uquant.data_update": "cli_runner",
    ...
    "uquant.market.valuation": "production_safe",
    ...
    "uquant.models.strategic_epoch": "production_safe",
    "uquant.models.strategic_grant": "production_safe",
    "uquant.models.strategic_rearm": "production_safe",
    "uquant.models.strategic_universe": "production_safe",
    ...
    "uquant.portfolio.allocation_book": "production_safe",
    "uquant.portfolio.allocator": "production_safe",
    "uquant.portfolio.capital": "production_safe",
    ...
    "uquant.portfolio.recovery.current_cohort": "production_safe",
    ...
    "uquant.portfolio.strategic.authority": "production_safe",
    "uquant.portfolio.strategic.discovery": "production_safe",
    "uquant.portfolio.strategic.grant_lifecycle": "production_safe",
    "uquant.portfolio.strategic.lifecycle": "production_safe",
    "uquant.portfolio.strategic.ownership": "production_safe",
    "uquant.portfolio.strategic.qualification_candidates": "production_safe",
    "uquant.portfolio.strategic.quorum": "production_safe",
    "uquant.portfolio.strategic.rearm": "production_safe",
    "uquant.portfolio.strategic.rearm_predicates": "production_safe",
    ...
    "uquant.validation.absolute_generalization.champion_physical": "validation_runner",
    ...
    "uquant.validation.absolute_generalization._reachability_codec": "validation_runner",
    "uquant.validation.absolute_generalization._reachability_graph": "validation_runner",
    "uquant.validation.absolute_generalization._reachability_recovery": "validation_runner",
    "uquant.validation.absolute_generalization._recovery_runtime_fixtures": "validation_runner",
    "uquant.validation.absolute_generalization._replay_codec": "validation_runner",
    "uquant.validation.absolute_generalization.aggregation": "validation_runner",
    "uquant.validation.absolute_generalization.artifacts": "validation_runner",
    "uquant.validation.absolute_generalization.contract": "validation_runner",
    "uquant.validation.absolute_generalization.metrics": "validation_runner",
    "uquant.validation.absolute_generalization.policy": "validation_runner",
    "uquant.validation.absolute_generalization.reachability": "validation_runner",
    "uquant.validation.absolute_generalization.recovery_runtime": "validation_runner",
    "uquant.validation.absolute_generalization.replay": "validation_runner",
    "uquant.validation.absolute_generalization.runtime": "validation_runner",
