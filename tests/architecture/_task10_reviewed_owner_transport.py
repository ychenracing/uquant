...
def reviewed_task10_owner_source(root: Path, relative: str, name: str) -> str:
...
def expand_reviewed_task10_owner(
    *,
    root: Path,
    relative: str,
    name: str,
    ...
    start_source = _git_source(root, TASK10_START_COMMIT, relative)
    ...
    reviewed_source = reviewed_task10_owner_source(root, relative, name)
    candidate_source = (
        overrides[relative]
