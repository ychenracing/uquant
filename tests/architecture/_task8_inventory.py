...
TASK8_START = "4b6bedb03fb7c58914d9d5032a2514c67f41f6ba"
TASK8_START_TREE = "d3824f7c5d89521b8284b5de08cc1e82e3ab7ebd"
...
def build_task8_inventory(root: Path) -> dict[str, Any]:
        ...
        entries.append(
            {
                ...
                "restore_commands": [
                    ...
                    f"git restore --source={TASK8_START} --staged --worktree -- {path}",
                ],
    ...
    payload: dict[str, Any] = {
        "baseline_commit": TASK8_START,
        "baseline_tree": TASK8_START_TREE,
