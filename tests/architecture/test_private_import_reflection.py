...
def test_architecture_raw_scanner_rejects_reflective_loader_namespace_bypasses(
    source: str,
    owner: str | None,
    kind: str,
) -> None:
...
def test_architecture_raw_scanner_rejects_module_valued_bounded_exports(
    consumer: str,
    owner: str,
    helper: str,
) -> None:
...
def test_architecture_raw_scanner_rejects_module_valued_explicit_reexports(
    owner: str,
    bridge: str,
    consumer: str,
    bucket: str,
...
def test_architecture_raw_scanner_rejects_module_valued_attribute_reexports(
    owner: str,
    consumer: str,
    bucket: str,
    evidence: str,
...
def test_architecture_raw_scanner_rejects_unmodelled_scope_reexports(
    owner: str,
    case_id: str,
) -> None:
    mutation = {
...
def test_architecture_raw_scanner_rejects_cross_module_capability_reexports(
    owner: str,
    consumer: str,
) -> None:
    mutation = {
...
def test_architecture_raw_scanner_rejects_imported_function_globals_namespace(
...
def test_architecture_raw_scanner_rejects_stdlib_module_recovery(
    source: str,
) -> None:
    mutation = {
        "uquant/account/codec.py": source,
...
def test_architecture_raw_scanner_rejects_trace_callback_frame_namespace() -> None:
    mutation = {
        "uquant/account/codec.py": (
            "import sys\n"
            "from uquant.account.validation_common import finite_number\n"
...
def test_architecture_raw_scanner_allows_bounded_source_file_inspection() -> None:
    mutation = {
        "research/probe.py": (
            "import inspect\n"
            "from uquant.account.validation_common import finite_number\n"
...
def test_architecture_raw_scanner_rejects_registry_and_loader_derivations(
    source: str,
) -> None:
    mutation = {
        "uquant/account/codec.py": source,
...
def test_architecture_raw_scanner_rejects_serialized_private_object_recovery(
    source: str,
) -> None:
    mutation = {
...
def test_architecture_raw_scanner_rejects_object_recovery_provider_aliases(
    source: str,
) -> None:
    mutation = {
        "research/probe.py": source,
...
def test_architecture_raw_scanner_rejects_nested_object_recovery_providers(
    source: str,
) -> None:
    mutation = {
        "research/probe.py": source,
...
def test_architecture_raw_scanner_keeps_ordinary_provider_members_bounded(
    source: str,
) -> None:
    mutation = {
        "research/probe.py": source,
