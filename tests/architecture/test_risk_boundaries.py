...
@pytest.mark.parametrize("path, before, after", (
    ...
    ("uquant/holding_history.py", "fill.order_id and fill.event_id", "True"),
    ("uquant/holding_history.py", 'fill.mechanism != "RECOVERY_COHORT"', 'False'),
    ("uquant/holding_history.py", 'fill.origin_subsystem == "RISK"', 'True'),
    ("uquant/holding_history.py", "started and shares == actual", "started"),
