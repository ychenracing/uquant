...
def test_task10_raw_scanner_rejects_native_python_object_recovery(
    binding: str,
) -> None:
    mutation = {
...
def test_task10_raw_scanner_rejects_low_level_ctypes_object_recovery() -> None:
    source = (
        "import _ctypes\n"
...
def test_task10_raw_scanner_rejects_runtime_class_loader_recovery(
    source: str,
) -> None:
    mutation = {
        "uquant/account/codec.py": source,
...
def test_task10_raw_scanner_accepts_bounded_runtime_class_uses(source: str) -> None:
    mutation = {
        "uquant/account/codec.py": source,
        "uquant/account/__init__.py": "",
        "uquant/__init__.py": "",
...
def test_task10_raw_scanner_rejects_runtime_import_implementation_providers(
    source: str,
) -> None:
    mutation = {
        "uquant/account/codec.py": source,
...
def test_task10_raw_scanner_accepts_bounded_ctypes_uses(source: str) -> None:
    mutation = {
...
def test_task10_raw_scanner_rejects_unbounded_kernel32_symbol_access(
    loader: str,
) -> None:
    mutation = {
...
def test_task10_raw_scanner_rejects_kernel32_object_transport() -> None:
    mutation = {
        "uquant/account/codec.py": (
            "import ctypes\n"
...
def test_task10_raw_scanner_accepts_exact_windows_file_lock_symbols() -> None:
    mutation = {
