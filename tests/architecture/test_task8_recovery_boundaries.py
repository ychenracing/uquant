...
def test_task8_checkpoint4_recovery_owners_and_thin_facade_are_complete() -> None:
    assert all((ROOT / path).is_file() for path in _CHECKPOINT4_PACKAGE_PATHS)
...
def test_task8_checkpoint4_substitution_method_and_targets_are_ast_exact() -> None:
...
def test_task8_checkpoint4_ast_gate_rejects_recovery_rule_mutations() -> None:
...
def test_task8_checkpoint4_private_and_complexity_relocations_are_closed() -> None:
