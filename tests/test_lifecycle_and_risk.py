...
from _lifecycle_strategic_cohort_cases import (
    ...
    test_strategic_epoch_respects_risk_gate_without_global_exit_cooldown,
    ...
    test_legacy_rearm_date_cannot_manufacture_generic_entry,
    test_legacy_handoff_marker_cannot_manufacture_generic_entry,
...
from _lifecycle_freeze_tactical_probe_cases import (
    ...
    test_caution_freeze_keeps_healthy_recovery_holding_within_hard_name_cap,
    test_empty_book_freeze_cannot_open_a_tactical_probe,
    test_capital_clean_caution_does_not_bypass_a_buy_freeze,
    test_shallow_empty_book_rebound_does_not_justify_a_full_tactical_probe,
    test_independent_rebound_breadth_cannot_expand_a_frozen_account,
    test_oversold_rebound_evidence_cannot_expand_a_frozen_account,
    test_oversold_shallow_rebound_needs_medium_term_convexity,
    test_modest_extension_does_not_authorize_frozen_recovery_entry,
...
from _lifecycle_recovery_admission_cases import (
    test_same_session_recovery_observation_cannot_advance_unqualified_entry,
    test_unqualified_recovery_expansion_keeps_the_physical_incumbent,
    test_risk_anchor_breadth_does_not_create_tradable_qualification,
...
from _lifecycle_protected_repair_cases import (
    test_hard_risk_preserves_confirmed_structural_exits_and_physical_accounting,
    test_level1_repair_metadata_cannot_open_a_frozen_empty_book,
    test_deep_recovery_new_high_cannot_open_a_frozen_empty_book,
    test_level1_repair_without_candidate_retains_existing_generic_core,
    test_protected_intent_survives_freeze_until_account_buy_gate_reopens,
    test_synchronized_repair_metadata_cannot_expand_frozen_protected_holdings,
    test_protected_restore_uses_real_capacity_before_and_after_fills,
)
...
from _lifecycle_strategic_restore_cases import (
    ...
    test_strategic_restore_waits_for_fills_and_respects_shared_caps,
    test_level2_strategic_restore_funds_missing_members_only_after_sell_fills,
    test_frozen_recovery_keeps_saved_rights_without_industry_quorum_clearing,
    test_single_industry_protection_cannot_bypass_a_buy_freeze,
    test_unrelated_industries_cannot_expand_frozen_recovery_targets,
...
from _lifecycle_leader_recovery_cases import (
    test_unified_core_hold_preserves_legacy_tranches_without_automatic_pyramiding,
    test_legacy_dynamic_k_and_arm_flags_cannot_bypass_entry_confirmation,
    ...
    test_legacy_recovery_targets_cannot_fund_unqualified_missing_members,
    test_healthy_core_holdings_need_no_recovery_graduation,
    test_fully_exited_recovery_anchors_cannot_hijack_a_later_leader_book,
    test_weak_market_metadata_retains_healthy_recovery_and_core_holdings,
    test_recovery_holdings_retain_physical_lifecycle_without_graduation,
)
...
from _lifecycle_restoration_risk_cases import (
    ...
    test_confirmed_structural_exit_remains_executable_through_a_caution_freeze,
