...
def test_phase1_equivalence_rejects_a_dirty_frozen_checkout_before_replay(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_rejects_a_checkout_dirtied_during_replay(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_rejects_an_untracked_runtime_hook(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_rejects_unbound_market_data(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_retains_one_data_snapshot_and_detects_source_drift(
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_snapshot_excludes_unauthenticated_entries(
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_snapshot_fails_closed_at_copy_boundaries(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_phase1_equivalence_rejects_private_data_snapshot_mutation(
    tmp_path: Path,
) -> None:
...
def test_phase1_equivalence_replays_private_source_and_data_snapshots(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
...
def test_phase1_trace_disables_site_initialization(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
...
def test_phase1_partial_worktree_add_is_cleaned_up(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
) -> None:
