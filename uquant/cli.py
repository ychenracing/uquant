...
def _validate_account_configuration(account: AccountState, cfg: SystemConfig) -> None:
    """Use the same bound policy for reconciliation and daily decisions."""
...
def _run_daily(args: argparse.Namespace) -> int:
    ...
    _validate_account_configuration(account, cfg)
    engine = ProductionEngine(args.data_dir, cfg)
