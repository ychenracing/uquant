...
_aliases = _atomic_files.atomic_path_aliases
_existing_destination_mode = _atomic_files.existing_destination_mode
_fsync_directory = _atomic_files.fsync_directory
_open_temporary = _atomic_files.open_temporary
_reject_symlink_path = _atomic_files.reject_symlink_path
