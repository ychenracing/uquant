...
class PortfolioAllocator:
    """Convert leader and risk evidence into the portfolio's only target set.

    The allocator owns lifecycle state, hysteresis, position-count changes,
    recovery anchors, strategic cohorts, and rotation. It emits weights only;
    order construction remains isolated in the execution layer.
    """
