...
from .artifact_transaction import _read_protected_artifact, _resolved_path_text
...
def _read_checkpoint_carrier(
    ...
    *,
    ...
    if (
        ...
        or raw.get("production_source_sha256") != runtime_compatibility_value("holdout_source_sha256", holdout_source_sha256)(Path(__file__).resolve().parents[3])
